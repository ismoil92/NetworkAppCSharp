...
namespace ChatDB.Migrations
{
    ...
    [Migration("20231228113322_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatCommon.Message", b =>
                {
            ...
            modelBuilder.Entity("ChatCommon.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatCommon.Message", b =>
                {
                    b.HasOne("ChatCommon.User", "UserFrom")
                        .WithMany("MessagesFrom")
                        .HasForeignKey("UserFromId")
                        .HasConstraintName("messageFromUserFK");

                    b.HasOne("ChatCommon.User", "UserTo")
                        .WithMany("MessagesTo")
